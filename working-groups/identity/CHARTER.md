...
| Sub Streams                               | Details                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Leads                                | GitHub Profile                    |
| ----------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ | ---------------------------------- |
...
| 4. Agentic Identity Interconnect          | Establish liaisons and collaborative interplays with other ongoing initiatives within the Linux Foundation (LF) to ensure alignment and shared progress. Strengthen relationships, avoid duplication, and foster joint innovation across LF projects.                                                                                                                                                                                                                                                     | Sarah Evans (Dell)                   | <https://github.com/sevansdell>    |
| 5. Brokered Identity Gateways             | Enabling secure, seamless authentication across platforms through brokered identity and gateway integrations.                                                                                                                                                                                                                                                                                                                                                                                             | Manish Singh (Datum.net)             |     <https://github.com/mksinghtx>   |
...
| 7. AGNTCY/CREDO integration for agentic IAM work | A collaboration between AGNTCY (Linux Foundation's Internet of Agents infrastructure) and Open Wallet Foundation's CREDO identity wallet creates the missing production-ready bridge between enterprise-grade decentralized identity management and multi-agent system orchestration. This partnership would deliver the only open-source, standards-compliant solution that fully implements the Cloud Security Alliance (CSA) Agentic AI IAM framework's vision of rich, verifiable agent identities operating across organizational boundaries and levels of autonomy.                                                                                                                                                                                                                                                                                                                                                                                               | Jim St.Clair (MyLigo)             |                                    |
