...
| Group   | Design Docs | Slack / Discord / GH Discussions  | Description  |
| ------------------------------------- | ---------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | ------------------------------------- |
| [Core](#core)                         | Design Docs in GH repos | [#wg-core](https://agntcy.slack.com/archives/C08R1LZEP0V) :: [SLIM Discord](https://discord.gg/hdTDzBQe7D) :: [Dir Discord](https://discord.gg/FbEnSHXD34) :: [SLIM GH Discussions](https://github.com/agntcy/slim/discussions) :: [Dir GH Discussions](https://github.com/agntcy/dir/discussions) :: [OASF GH Discussions](https://github.com/agntcy/oasf/discussions) :: [OASF-SDK GH Discussions](https://github.com/agntcy/oasf-sdk/discussions) | AGNTCY core working group             |
...
- Roadmap:
  - [SLIM](https://github.com/orgs/agntcy/projects/4/views/8)
  - [Agent Directory](https://github.com/orgs/agntcy/projects/4/views/4)
  - [OASF](https://github.com/orgs/agntcy/projects/4/views/9)
...
- Discussions: 
  - [AGNTCY slack #wg-core](https://agntcy.slack.com/archives/C08R1LZEP0V)
    - [#slim](https://agntcy.slack.com/archives/C08R87FSH4L) :: [SLIM Discord](https://discord.gg/hdTDzBQe7D)
    - [#directory](https://agntcy.slack.com/archives/C08RT2918V6) :: [Dir Discord](https://discord.gg/FbEnSHXD34)
...
- Roadmap:
  - [Observe-SDK](https://github.com/agntcy/telemetry-hub)
  - [Telemetry-Hub](https://github.com/agntcy/telemetry-hub)
- Meetings: [See AGNTCY Calendar](https://calendar.google.com/calendar/embed?src=admin%40ops.agntcy.org&ctz=America%2FNew_York)
- Repos:
  - [Observe-SDK](https://github.com/agntcy/observe)
  - [Telemetry Hub](https://github.com/agntcy/telemetry-hub)
- Discussions:
  - [AGNTCY slack #wg-observ-and-eval](https://agntcy.slack.com/archives/C08RMAML6JH)
  - [GH Discussions](https://github.com/agntcy/observe/discussions)
...
- Discussions:
  - [AGNTCY slack #wg-identity](https://agntcy.slack.com/archives/C08TZPX83KR)
...
- [Roadmap](https://github.com/orgs/agntcy/projects/4/views/16)
- Meetings: [See AGNTCY Calendar](https://calendar.google.com/calendar/embed?src=admin%40ops.agntcy.org&ctz=America%2FNew_York)
- Repos:
  - [app-sdk](https://github.com/agntcy/app-sdk)
  - [coffeeAgntcy](https://github.com/agntcy/coffeeAgntcy/)
- Discussions:
  - [AGNTCY slack #wg-coffee-app-sdk](https://agntcy.slack.com/archives/C0979J92X9C)
  - [GH Discussions](https://github.com/agntcy/coffeeAgntcy/discussions)
